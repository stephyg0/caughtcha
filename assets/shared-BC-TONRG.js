import{ci as X,c$ as D,gq as x,en as V,d$ as q,ex as j,eT as G,h5 as Y,f4 as z,cF as P,dY as R,dU as K,df as J,cV as Q,hc as tt,e8 as et,e5 as nt,bm as ot,he as rt,cO as st,ch as it,h1 as lt,g4 as at,cE as ct,bW as N,eL as ut,cT as ht,dT as ft,eb as gt,ec as pt,ed as dt,eh as mt,ei as wt,ee as It,eg as St,ef as Et,ek as _,el as Rt,em as xt,ej as vt,dA as F,dO as yt,gS as A,fG as Tt}from"./index-Dz7qLT9l.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function bt(n,t,e,o){if(o==="int32"){const r=Int32Array.from(n);return[t,"int32",r]}if(o==="bool"){const r=Y([0],e),[i,s]=v((a,l)=>a!==l?1:0)(t,[],n,r,"bool");return[s,"bool",i]}throw new Error(`Error in Cast: failed to cast ${e} to ${o}`)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Nt(n,t,e,o,r,i,s,a,l){const c=P([o,i],e);for(let u=0;u<o;u++){const h=[];let d=0;for(let m=0;m<r;m++){const g=n[u*r+m];d+=g*s[m],h.push(g)}if(d<0||d>=l/i)throw new Error(`Invalid indices: ${h} does not index into ${a}`);for(let m=0;m<i;m++)c.values[u*i+m]=t.get(...t.indexToLoc(d*i+m))}return c}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jt(n,t,e){const o=P(e,n.dtype);for(let r=0;r<o.size;++r){const s=o.indexToLoc(r).slice(),a=s[0],l=s[2],c=t.locToIndex([a,l]);s[2]=t.values[c];const u=n.locToIndex(s);0<=u&&u<n.values.length&&(o.values[r]=n.values[u])}return o}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Xt(n,t,e){const o=J(-1,e);return Z([],t,o,n,e)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Jt(n,t,e,o,r){const i=t.length,s=x(t),a=D(t),l=D(r),c=V(e,x(r));for(let u=0;u<s;++u){const h=j(u,i,a),d=new Array(h.length);for(let g=0;g<d.length;g++)d[g]=h[o[g]];const m=G(d,i,l);c[m]=n[u]}return c}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qt(n,t,e,o){const[r,i]=Q(n,o),s=tt(t,"int32"),a=z(x(r),s),l=x(i);for(let c=0;c<a.length;++c){const u=c*l;let h=1;for(let d=0;d<l;++d)h*=e[u+d];a[c]=h}return{outVals:a,outShape:r,outDtype:s}}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Pe(n,t,e,o){const r=Tt(t,e)[0],i=[1,e[0],1];for(let g=0;g<r;g++)i[0]*=e[g];i[1]=e[r];for(let g=r+1;g<e.length;g++)i[2]*=e[g];const s=new Map,a=new Int32Array(e[r]),l=new N(i,o,n),c=[],u=i[0]===1&&i[2]===1;for(let g=0;g<e[r];g++){let I;if(u)I=n[g].toString();else{const p=[];for(let w=0;w<i[0];w++)for(let E=0;E<i[2];E++)p.push(l.get(w,g,E));I=p.join(",")}const f=s.get(I);if(f!=null)a[g]=f;else{const p=s.size;s.set(I,p),a[g]=p,c.push(g)}}const h=i.slice();h[1]=s.size;const d=new N(h,o);c.forEach((g,I)=>{for(let f=0;f<i[0];f++)for(let p=0;p<i[2];p++)d.set(l.get(f,g,p),f,I,p)});const m=e.slice();return m[r]=h[1],{outputValues:d.values,outputShape:m,indices:a}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const De=Object.freeze(Object.defineProperty({__proto__:null,addImpl:Pt,bincountImpl:Ot,bincountReduceImpl:Dt,bitwiseAndImpl:At,castImpl:bt,ceilImpl:Lt,concatImpl:Vt,equalImpl:zt,expImpl:$t,expm1Impl:Wt,floorDivImpl:Gt,floorImpl:Ft,gatherNdImpl:Nt,gatherV2Impl:jt,greaterEqualImpl:_t,greaterImpl:qt,lessEqualImpl:kt,lessImpl:Ct,linSpaceImpl:Ut,logImpl:Bt,maxImpl:Kt,maximumImpl:Zt,minimumImpl:Ht,multiplyImpl:Z,negImpl:Xt,notEqualImpl:Yt,prodImpl:Qt,raggedGatherImpl:ie,raggedRangeImpl:le,raggedTensorToTensorImpl:ae,rangeImpl:ce,rsqrtImpl:ue,scatterImpl:he,sigmoidImpl:fe,simpleAbsImpl:Mt,sliceImpl:ge,sparseFillEmptyRowsImpl:pe,sparseReshapeImpl:de,sparseSegmentReductionImpl:me,sqrtImpl:we,staticRegexReplaceImpl:Ie,stridedSliceImpl:Se,stringNGramsImpl:Re,stringSplitImpl:ve,stringToHashBucketFastImpl:ye,subImpl:Te,tileImpl:Me,topKImpl:be,transposeImpl:Jt,uniqueImpl:Pe},Symbol.toStringTag,{value:"Module"}));export{De as s};
